...
class PlatformView:
    def __init__(self, root, controller):
        self.root = root
        self.controller = controller
        self.short_name_entry = tk.Entry(root)
        self.short_name_entry.pack(pady=10)
        self.short_name_entry.insert(0, "Short Name")
        self.long_name_entry = tk.Entry(root)
        self.long_name_entry.pack(pady=10)
        self.long_name_entry.insert(0, "Long Name")
        self.url_entry = tk.Entry(root)
        self.url_entry.pack(pady=10)
        self.url_entry.insert(0, "URL")
        self.add_button = tk.Button(root, text="Add Platform", command=self.controller.add_platform)
